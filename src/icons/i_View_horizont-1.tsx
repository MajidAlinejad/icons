const SvgComponent = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      stroke="currentColor"
    />
    <path d="M16.5 12H20.5" stroke="currentColor" stroke-linecap="round" />
    <path d="M16.5 9.5L20.5 8" stroke="currentColor" stroke-linecap="round" />
    <path d="M16.5 14.5L20.5 16" stroke="currentColor" stroke-linecap="round" />
  </svg>
);
